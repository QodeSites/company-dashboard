    ...
    const exportToExcel = useCallback(() => {
        ...
        activeCustodianCodes.forEach((custodianCode, rowIndex) => {
            ...
            activeStockKeys.forEach((stockKey, colIndex) => {
                ...
                if (tab === "change") {
                    if (rowFilters[stockKey] === "none" || item.asset_class === "Cash") {
                        row.push("-");
                        return;
                    }
                        ...
                        <table className="min-w-full text-sm bg-white">
                            <thead className="bg-gray-100 text-gray-600 uppercase font-semibold text-xs">
                                <tr>
                                    ...
                                    {selectedClients.map((custodianCode) => {
                            ...
                            <tbody>
                                {sortedSummaryData.length === 0 ? (
                                    <tr>
                                        <td
                                            colSpan={selectedClients.length + 5}
                                            ...
                                            {selectedClients.map((custodianCode) => (
                                                ...
                                                >
                                                    {displayMode === "percent"
                                                        ...
                                                        : formatNumber(calculateTotals(sortedSummaryData, true).clientTotals[custodianCode])}
                                                </td>
                                            ))}
                                        </tr>
                                    </>
