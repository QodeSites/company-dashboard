...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    icon: <BoxCubeIcon />,
    subItems: [
      { name: "Upload Data", path: "/pms/upload-data" },
      { name: "PMS Allocation", path: "/pms-allocations" },
    ],
  },
];
    ...
    >
      ...
      >
        <Link href="/">
          {isExpanded || isHovered || isMobileOpen ? (
            <>
              <h1 className="playfair-display-font text-5xl font-extrabold text-[#d1a47b]">Qode</h1>
            </>
          ) : (
            <>
              <h1 className="playfair-display-font text-5xl font-extrabold text-[#d1a47b]">Q</h1>
            </>
          )}
        </Link>
      </div>
